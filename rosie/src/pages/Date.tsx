import { IonContent, IonFab, IonFabButton, IonHeader, IonPage, IonImg, IonTitle, IonActionSheet, IonToolbar, IonButtons, IonMenuButton, IonButton, IonIcon, IonGrid, IonRow, IonCol } from '@ionic/react';
import { personCircle, backspace, flower, trash, close, closeCircle, ticket, checkmark } from 'ionicons/icons';
